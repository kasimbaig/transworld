...
export class RefitComponent {
  ...
  cols = [
    { field: 'id', header: 'Refit ID' },
    { field: 'name', header: 'Refit Type' },
    { field: 'name', header: 'Refit Category ID' },
    { field: 'name', header: 'Created By' },
    { field: '', header: 'Updated By' },
