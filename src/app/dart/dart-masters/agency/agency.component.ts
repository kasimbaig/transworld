...
export class AgencyComponent {
  ...
  handleEditSubmit(data: any) {
    ...
    this.apiService
      ...
      .subscribe({
        next: (data: any) => {
          console.log(data);
          this.toastService.showSuccess('Propulsion Updated Successfully');
  ...
  cols = [
    { field: 'id', header: 'ID' },
    { field: 'name', header: 'Delay ID' },
    { field: 'name', header: 'Delay Code' },
    { field: 'name', header: 'Delay Name' },
    { field: '', header: 'ISMS Delay Name' },
