...
export class ReportComponent implements OnInit, OnChanges{
  ...
  // Precomputed data columns to avoid heavy template calls
  dataColumns: any[] = [];

  // Cache for nested arrays per item
  ...
  trackByHeader(index: number, col: any): any { return col?.label || col?.key || index; }
